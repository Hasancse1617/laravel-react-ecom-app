import { REMOVE_SINGLE_CATEGORY, REMOVE_CATEGORY_ERRORS, REMOVE_CATEGORY_LOADER, REMOVE_CATEGORY_MESSAGE, REMOVE_CATEGORY_REDIRECT, SET_SINGLE_CATEGORY, SET_CATEGORIES, SET_CATEGORY_ERRORS, SET_CATEGORY_LOADER, SET_CATEGORY_MESSAGE, SET_CATEGORY_REDIRECT, CATEGORY_STATUS, SET_PARENT_CATEGORIES } from "../types/CategoryType";
...
const CategoryReducer = (state=initState, action) =>{
    ...
    else if(action.type === SET_PARENT_CATEGORIES){
        return{...state, parent_categories: action.payload}
    }
    else{
        return state;
    }
