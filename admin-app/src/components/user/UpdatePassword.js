                ...
                <form role="form" onSubmit={UserPassword}>
                    ...
                    <div class="form-group row">
                        ...
                        <div className="col-sm-8">
                           <input type="password" name="old_password" value={state.old_password} onChange={handleInput} class="form-control" id="exampleInputName" placeholder="Enter Password"/>
                        </div> 
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div className="col-sm-8">
                        <input type="password" name="confirm_password" value={state.confirm_password} onChange={handleInput} class="form-control" id="exampleInputEmai" placeholder="Enter Confirm Password"/>
                        </div> 
                    </div>
