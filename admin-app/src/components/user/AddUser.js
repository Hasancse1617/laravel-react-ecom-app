...
const AddUser = (props) => {
    ...
    const createUser = (e) =>{
        e.preventDefault();
        const {name,email,mobile,image,user_type,password,c_password} = state;
    ...
    return (
        ...
        <Helmet>
            <title>Create user - Ecom website</title>
        ...
        <div class="container-fluid">
            ...
            <div class="col-12">
                ...
                <form role="form" onSubmit={createUser}>
                    ...
                    <div class="form-group row">
                        <label for="exampleInputEmail2" className="col-sm-2  col-form-label">User Mobile</label>
                        <div className="col-sm-8">
                           <input type="tel" name="mobile" pattern="[0-9]{5}-[0-9]{6}" value={state.mobile} onChange={handleInput} class="form-control" id="exampleInputEmail2" placeholder="01738-385467" required/>
                        </div> 
                    </div>
                    <div class="form-group row">
