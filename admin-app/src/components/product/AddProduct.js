...
import { fetchbrands, fetchcategories, createAction } from "../../store/actions/ProductAction";
import { REMOVE_PRODUCT_ERRORS } from "../../store/types/ProductType";


const AddProduct = (props) => {
    const dispatch = useDispatch();
    const { productErrors,redirect,categories,brands } = useSelector((state)=> state.ProductReducer);
